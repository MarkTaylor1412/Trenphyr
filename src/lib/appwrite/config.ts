...
export const appwriteConfig = {
    ...
    userColId: import.meta.env.APPWRITE_USER_COLLECTION_ID,
    postColId: import.meta.env.APPWRITE_POST_COLLECTION_ID,
    savesColId: import.meta.env.APPWRITE_SAVES_COLLECTION_ID,
}
